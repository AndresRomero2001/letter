...
/* Small negative margins so the PNG layers overlap seamlessly */
.papyrus-header-img{margin-bottom:-1px}
.papyrus-footer-img{margin-top:-1px}
.papyrus-body{
  position:relative;
...
.letter-content{
  ...
  font-size:1.2rem;line-height:1.95;color:#f5eed6;
